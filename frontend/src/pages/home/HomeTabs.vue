...
onMounted(() => {
  // Bootstrap tabs will be initialized by scripts.js
  // The tab markup uses data-toggle="tab" which Bootstrap handles
})
</script>
